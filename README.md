...
VarTrix has automatically generated downloadable binaries for generic linux and Mac OSX under the [releases page](https://github.com/10XGenomics/vartrix/releases). The linux binaries are expected to work on [any of our supported OSes](https://support.10xgenomics.com/os-support). 
